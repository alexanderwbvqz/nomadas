...
export default function TarjetaSesionCeo({
  sesion, jugadorUrl, enviando,
  onAbrir, onEliminar, onEnviarCorreos, onVerResultados,
}: TarjetaSesionCeoProps) {
  return (
    <div className="tarjeta-sesion-ceo">
      <div className="tarjeta-sesion-ceo__principal">
      ...
      <div className="tarjeta-sesion-ceo__enlaces">
        <a
          href={jugadorUrl}
          target="_blank"
          rel="noreferrer"
          className="tarjeta-sesion-ceo__enlace"
        >
          Enlace jugadores
        </a>
        <button
          className="tarjeta-sesion-ceo__btn"
          onClick={onEnviarCorreos}
          disabled={enviando}
        >
          {enviando ? 'Enviando...' : 'Enviar correos'}
        </button>
        {sesion.estado === 'finalizado' && (
          <button className="tarjeta-sesion-ceo__btn" onClick={onVerResultados}>
            Ver resultados
          </button>
        )}
      </div>
