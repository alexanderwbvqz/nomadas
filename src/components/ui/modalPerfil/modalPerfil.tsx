import { X, Clock, Lightbulb, Heart, Zap, Users, Star, DollarSign, Globe, Quote, Mail, Shield, Award, BookOpen, Rocket } from 'lucide-react'
        ...
        {cargando || !perfil ? (
          ...
          <>
            ...
            <div className="modal-perfil__cuerpo">
              ...
              {perfil.tieneEmprendimiento && (
                <div className="modal-perfil__seccion">
                  <div className="modal-perfil__seccion-titulo">
                    <Rocket size={14} /> ¿Tiene emprendimiento en marcha?
                  </div>
                  <p className="modal-perfil__texto">
                    {perfil.tieneEmprendimiento}
                    {perfil.tieneEmprendimiento === 'Sí' && perfil.detalleEmprendimiento
                      ? ` — "${perfil.detalleEmprendimiento}"`
                      : ''}
                  </p>
                </div>
              )}
              ...
              {perfil.redes.length > 0 && (
                <div className="modal-perfil__seccion">
                  ...
                  <RedesSociales redes={perfil.redes} />
                </div>
              )}
            </div>
